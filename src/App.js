  ...
  render() {
    if (!this.props.initialized) {
      return (
        <img
          className={"preloader"}
          src={coloredCircleIMG}
          alt={"app initializing loader"}
        />
      );
    }
    return (
      <div className="app-wrapper">
        ...
        <div className="app-wrapper-content">
          <Switch>
            ...
            <Route
              path={"/users_from_axios"}
              render={() => <UsersWithAxiosContainer />}
            />
...
let DefaultApp = compose(
  withRouter,
  connect(mapStateToProps, appReducerAC)
)(App);
