...
const Friends = (props) => {
    ...
    let randomFriendList = [], alreadyGeneratedNumbers = []
    ...
    let FinalFriendListComponent = randomFriendList.map(id => <UserAvatar generalInfo={props.usersInfo.generalInfo}
                                                                          id={id.id} width={30}/>)
    return (
        <div>
