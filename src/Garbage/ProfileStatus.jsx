    ...
    return (
      <div>
        {!this.state.editModeStatus && (
          <div>
            <span style={Style} onClick={this.activateEditMode}>
              {this.props.profileStatusInputArea}
            </span>
          </div>
        )}
        {this.state.editModeStatus && (
          <div>
            <input
              onKeyPress={this.confirmStatusField}
              onChange={this.editStatusField}
              onBlur={this.deactivateEditMode}
              value={this.props.profileStatusInputArea}
              autoFocus={true}
              style={Style}
            ></input>
          </div>
