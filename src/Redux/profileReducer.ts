...
type profileReducerAcType = {
  ...
  updateProfileContainerOnRequestThunkCreator: (
    id: number
...
export const profileReducerAC: profileReducerAcType = {
  ...
  getProfileInfo: (response: Promise<object>) => ({
    type: GET_PROFILE_INFO,
    payload: response,
  }),
  showWaitingAnimation: (waitingCondition: boolean) => ({
    type: SHOW_WAITING_ANIMATION,
