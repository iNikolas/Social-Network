...
let store = {
  _state: {
    profile: {
      posts: [
        ...
        {
          avatar:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8-SJ6kQelXnm1CDV-Kw2s6oFEzVIFnIQjpw&usqp=CAU",
  ...
  _callSubscriber() {
    console.log("no Subscriber in the moment");
  },
  getState() {
    return this._state;
  },
  ...
  dispatch(action) {
    ...
    this._state.usersInfo = usersInfoReducer(this._state.usersInfo, action);
