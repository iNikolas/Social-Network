...
export const followAC = (idNumber) => ({type: FOLLOW, id: idNumber})
export const unfollowAC = (idNumber) => ({type: UNFOLLOW, id: idNumber})
export const setUsersInfoAC = (usersInfoData) => ({type: SET_USERS_INFO, usersInfo: usersInfoData})
    ...
    switch (action.type) {
        ...
        case UNFOLLOW: {
            ...
            if (isFollowed) {
                return {
                    ...state,
                    friendsList: state.friendsList.filter(idInformation => idInformation.id !== idData)
        ...
        case SET_USERS_INFO:
            return {
                ...action.usersInfo,
                generalInfo: [
                    ...action.usersInfo.generalInfo,
                ],
                friendsList: [
                    ...action.usersInfo.friendsList
                ]
            }
        default:
            return state
