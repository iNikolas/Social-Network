...
const SET_USERS_INFO = "SET-USERS-INFO";

type FollowAcType = (idNumber: number) => {
  type: typeof FOLLOW;
  id: typeof idNumber;
};
type UnfollowAcType = (idNumber: number) => {
  type: typeof UNFOLLOW;
  id: typeof idNumber;
};
type SetUsersInfoAC = (usersInfoData: InitialStateType) => {
  type: typeof SET_USERS_INFO;
  usersInfo: typeof usersInfoData;
};

export const followAC: FollowAcType = (idNumber) => ({
  type: FOLLOW,
  id: idNumber,
});
export const unfollowAC: UnfollowAcType = (idNumber) => ({
  type: UNFOLLOW,
  id: idNumber,
});
export const setUsersInfoAC: SetUsersInfoAC = (usersInfoData) => ({
  type: SET_USERS_INFO,
...
let initialState = {
  generalInfo: [
    ...
    },
    {
      name: "Андрей Огнев",
      id: 1,
      avatar: "https://download-cs.net/steam/avatars/3345.jpg",
      status: "",
      location: {
        city: "",
        country: "",
    ...
    },
    {
      name: "Иван Черняк",
      id: 2,
      avatar: "https://download-cs.net/steam/avatars/3357.jpg",
      status: "",
      location: {
        city: "",
        country: "",
    ...
    },
    {
      ...
      id: 4,
      avatar: "https://download-cs.net/steam/avatars/3298.jpg",
      status: "",
      location: {
        city: "",
        country: "",
  ...
  friendsList: [{ id: 1 }, { id: 2 }, { id: 4 }, { id: 5 }],
};
...
export const usersInfoReducer = (
  ...
  switch (action.type) {
    case FOLLOW: {
      ...
      state.friendsList.map((idInformation) => {
        if (action.id === idInformation.id) {
          isFollowed = true;
        }
        return isFollowed;
      });
      if (isFollowed) {
        ...
        return {
          ...state,
          friendsList: [...state.friendsList, { id: action.id }],
        };
      }
    }
    case UNFOLLOW: {
      ...
      if (isFollowed) {
        return {
          ...
          friendsList: state.friendsList.filter(
            (idInformation) => idInformation.id !== idData
          ),
        };
      } else {
        return {
    ...
    case SET_USERS_INFO:
      return {
        ...action.usersInfo,
        generalInfo: [...action.usersInfo.generalInfo],
        friendsList: [...action.usersInfo.friendsList],
      };
    default:
      return state;
  }
